...
zypper install memcached libmemcached-devel
...
echo install varnish deps
zypper install pcre pcre-devel automake libtool autoconf groff ncurses-devel-32bit ncurses-devel
